...
const InvoiceGenerator = () => {
    ...
    const fetchProducts = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://inventra-smart-inventory-manager.onrender.com/products', {
    ...
    const handleGenerateInvoice = async () => {
        ...
        try {
            const response = await fetch('https://inventra-smart-inventory-manager.onrender.com/createinvoice', {
                method: 'POST',
                headers: {
    ...
    const handleConfirmInvoice = async () => {
        ...
        try {
            const response = await fetch(`https://inventra-smart-inventory-manager.onrender.com/confirminvoice/${invoice._id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${token}`,
    ...
    const handlePrintInvoice = async () => {
        ...
        try {
            await fetch(`https://inventra-smart-inventory-manager.onrender.com/printinvoice/${invoice._id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${token}`,
