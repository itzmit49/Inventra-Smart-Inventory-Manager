...
export default function UpdateProduct() {
    ...
    useEffect(() => {
        const getProduct = async () => {
            ...
            try {
                const res = await fetch(`https://inventra-smart-inventory-manager-backend-yrr0.onrender.com/products/${id}`, {
                    method: "GET",
                    headers: {
    ...
    const updateProduct = async (e) => {
        ...
        try {
            const response = await fetch(`https://inventra-smart-inventory-manager-backend-yrr0.onrender.com/updateproduct/${id}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${token}`
